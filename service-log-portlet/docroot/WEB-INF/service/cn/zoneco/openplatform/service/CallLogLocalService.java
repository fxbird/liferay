...
/**
 * Provides the local service interface for CallLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fxbird
 * @see CallLogLocalServiceUtil
...
public interface CallLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CallLogLocalServiceUtil} to access the call log local service. Add custom service methods to {@link cn.zoneco.openplatform.service.impl.CallLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
