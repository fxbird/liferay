...
/**
 * Provides the local service interface for ZEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fxbird
 * @see ZEntityLocalServiceUtil
...
public interface ZEntityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZEntityLocalServiceUtil} to access the z entity local service. Add custom service methods to {@link cn.zoneco.openplatform.service.impl.ZEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
