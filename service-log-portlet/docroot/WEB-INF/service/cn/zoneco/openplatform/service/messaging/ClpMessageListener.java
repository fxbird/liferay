...
package cn.zoneco.openplatform.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AttachmentInfoLocalServiceUtil.clearService();

			CallLogLocalServiceUtil.clearService();

			CheckStatusLocalServiceUtil.clearService();

			ServiceInfoLocalServiceUtil.clearService();

			ZEntityLocalServiceUtil.clearService();
		}
	}
}