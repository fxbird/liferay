 ...
 * @generated
 */
public abstract class CallLogActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CallLogActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CallLogLocalServiceUtil.getService());
		setClass(CallLog.class);

		setClassLoader(cn.zoneco.openplatform.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("logId");
	}
}