 ...
 * @generated
 */
public abstract class ServiceInfoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ServiceInfoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ServiceInfoLocalServiceUtil.getService());
		setClass(ServiceInfo.class);

		setClassLoader(cn.zoneco.openplatform.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("resourceId");
	}
}