...
import cn.zoneco.openplatform.service.CallLogLocalService;
...
/**
 * Provides the base implementation for the call log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cn.zoneco.openplatform.service.impl.CallLogLocalServiceImpl}.
 * </p>
 *
 * @author fxbird
 ...
 * @generated
 */
public abstract class CallLogLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CallLogLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cn.zoneco.openplatform.service.CallLogLocalServiceUtil} to access the call log local service.
	 */
	...
	@Override
	public CallLog addCallLog(CallLog callLog) throws SystemException {
		callLog.setNew(true);

		return callLogPersistence.update(callLog);
	}
	 ...
	 */
	@Override
	public CallLog createCallLog(long logId) {
		return callLogPersistence.create(logId);
	}
	...
	@Override
	public CallLog deleteCallLog(long logId)
		throws PortalException, SystemException {
		return callLogPersistence.remove(logId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CallLog deleteCallLog(CallLog callLog) throws SystemException {
		return callLogPersistence.remove(callLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CallLog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return callLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return callLogPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return callLogPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return callLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return callLogPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public CallLog fetchCallLog(long logId) throws SystemException {
		return callLogPersistence.fetchByPrimaryKey(logId);
	}
	 ...
	 */
	@Override
	public CallLog getCallLog(long logId)
		throws PortalException, SystemException {
		return callLogPersistence.findByPrimaryKey(logId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return callLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CallLog> getCallLogs(int start, int end)
		throws SystemException {
		return callLogPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCallLogsCount() throws SystemException {
		return callLogPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CallLog updateCallLog(CallLog callLog) throws SystemException {
		return callLogPersistence.update(callLog);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cn.zoneco.openplatform.model.CallLog",
			callLogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = callLogPersistence.getDataSource();
	...
	private CallLogLocalServiceClpInvoker _clpInvoker = new CallLogLocalServiceClpInvoker();
}