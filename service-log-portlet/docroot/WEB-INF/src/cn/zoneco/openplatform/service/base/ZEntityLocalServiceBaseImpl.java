...
import cn.zoneco.openplatform.service.ZEntityLocalService;
...
/**
 * Provides the base implementation for the z entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cn.zoneco.openplatform.service.impl.ZEntityLocalServiceImpl}.
 * </p>
 *
 * @author fxbird
 ...
 * @generated
 */
public abstract class ZEntityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ZEntityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cn.zoneco.openplatform.service.ZEntityLocalServiceUtil} to access the z entity local service.
	 */
	...
	@Override
	public ZEntity addZEntity(ZEntity zEntity) throws SystemException {
		zEntity.setNew(true);

		return zEntityPersistence.update(zEntity);
	}
	 ...
	 */
	@Override
	public ZEntity createZEntity(long comId) {
		return zEntityPersistence.create(comId);
	}
	...
	@Override
	public ZEntity deleteZEntity(long comId)
		throws PortalException, SystemException {
		return zEntityPersistence.remove(comId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ZEntity deleteZEntity(ZEntity zEntity) throws SystemException {
		return zEntityPersistence.remove(zEntity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ZEntity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return zEntityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return zEntityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return zEntityPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return zEntityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return zEntityPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ZEntity fetchZEntity(long comId) throws SystemException {
		return zEntityPersistence.fetchByPrimaryKey(comId);
	}
	 ...
	 */
	@Override
	public ZEntity getZEntity(long comId)
		throws PortalException, SystemException {
		return zEntityPersistence.findByPrimaryKey(comId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return zEntityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ZEntity> getZEntities(int start, int end)
		throws SystemException {
		return zEntityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getZEntitiesCount() throws SystemException {
		return zEntityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ZEntity updateZEntity(ZEntity zEntity) throws SystemException {
		return zEntityPersistence.update(zEntity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cn.zoneco.openplatform.model.ZEntity",
			zEntityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = zEntityPersistence.getDataSource();
	...
	private ZEntityLocalServiceClpInvoker _clpInvoker = new ZEntityLocalServiceClpInvoker();
}