...
%><%
    ...
    AttachmentInfo attachmentInfo=AttachmentInfoLocalServiceUtil.getAttachmentInfo(attId);
...
//    FileOutputStream sos=new FileOutputStream("n:/temp/1.wsdl");

    InputStream fis=null;
	try {

//        response.flushBuffer();
        String fileName = attachmentInfo.getOriName();
//        response.setContentType(getContentType(fileName)+ "; charset=UTF-8");
        response.setContentType("application/x-download");
		response.setHeader("Content-disposition", "attachment; filename=" + new String(fileName.getBytes("GBK"), "iso8859-1"));

		fis =attachmentInfo.getAttContent().getBinaryStream();
